...
/*-----------------------------------------------------------------------------
  LOADING DATA
-----------------------------------------------------------------------------*/
minixhr('https://api.github.com/users/silarko', responseHandler1)
...
// function responseHandler1 (data) {
//   data = JSON.parse(data)
//   minixhr('https://api.github.com/users/silarko', responseHandler2)
// }
// function responseHandler2 (data) {
//   data.push(JSON.parse(data))
//   minixhr('https://api.github.com/users/silarko', responseHandler3)
// }
...
function footerComponent ({ data = {}, theme = {} } = {}) {
  ...
  function template () {
    ...
    <div class="${css.container}">
      <a href="https://github.com/silarko">
        <i class="${css.icon} fa fa-github" aria-hidden="true"></i>
      </a>
        <a href="mailto:milos_msc@yahoo.comcom ">
